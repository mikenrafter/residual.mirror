...
name: defense-walk
passthrough: true
description: Residual defense-walk — begin with residual skill show / skill data
---

The operator has requested you (agent) apply this residual skill in this project. Begin by running `residual skill show defense-walk` and `residual skill data defense-walk`.
